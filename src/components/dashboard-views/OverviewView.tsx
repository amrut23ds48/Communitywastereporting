      ...
      <div className="relative z-10 bg-white rounded-3xl p-5 md:p-8 border border-gray-100 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-8">
        <div className="flex-1 space-y-2 w-full">
          ...
          <p className="text-gray-500 text-xs md:text-sm">
            You are in the top <span className="text-emerald-600 font-bold">5%</span> of contributors.
          </p>
        </div>
        ...
        <div className="w-full md:w-1/3 bg-gray-50 p-4 rounded-2xl border border-gray-100">
          ...
          <p className="text-[10px] md:text-xs text-gray-400 mt-2 text-center">
            Earn <span className="text-emerald-600 font-bold">{nextLevelPoints - currentLevelPoints} more</span> for Level 6
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 relative z-10">
        ...
        <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-5 md:p-6 text-white shadow-lg shadow-emerald-200/50 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-3xl md:text-4xl font-bold mb-1">{user.points}</h3>
        ...
        <div className="bg-white rounded-2xl p-5 md:p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow group">
          ...
          <div className="space-y-1">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900">24</h3>
        ...
        <div className="bg-white rounded-2xl p-5 md:p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow group">
           <div className="flex items-start justify-between mb-4">
            ...
            <span className="text-[10px] font-bold text-purple-600 bg-purple-50 px-2 py-1 rounded-md">Sector 4</span>
          </div>
          <div className="space-y-1">
            <p className="text-gray-500 text-xs md:text-sm font-medium">Neighborhood Rank</p>
            <div className="flex items-baseline gap-2">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900">#4</h3>
              <span className="text-[10px] md:text-xs text-gray-400">of 1,240</span>
            </div>
             <p className="text-[10px] md:text-xs text-purple-600 font-medium">Top 1% in area</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 relative z-10">
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-5 md:p-6 flex flex-col h-full min-h-[300px]">
          ...
          <div className="space-y-2 flex-1">
            {[1, 2, 3].map((_, i) => (
              <div key={i} className="group flex items-center gap-3 md:gap-4 p-2 md:p-3 hover:bg-gray-50 rounded-2xl transition-all cursor-pointer border border-transparent hover:border-gray-100">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start mb-0.5">
                      <h4 className="font-bold text-gray-900 text-xs md:text-sm truncate pr-2">Garbage Dump on 5th Ave</h4>
                      <span className="text-[10px] text-gray-400 whitespace-nowrap">2h ago</span>
                  </div>
                  <p className="text-[10px] md:text-xs text-gray-500 truncate">Near City Center, Sector 4</p>
                </div>
                <div className={`hidden sm:block px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide rounded-md ${
