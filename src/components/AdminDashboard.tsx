        ...
        <div key={i} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-xl border border-gray-100 transition-colors group cursor-pointer">
          <div className="flex items-center gap-3">
             <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
               truck.status === 'Moving' ? 'bg-blue-100 text-blue-600' : 
          ...
          <div className="text-right">
             ...
             <span className={`text-[10px] px-2 py-0.5 rounded-md font-bold uppercase tracking-wide ${
                truck.status === 'Moving' ? 'bg-blue-50 text-blue-700' :
...
export function AdminDashboard({ onLogout }: AdminDashboardProps) {
  ...
  return (
    <div className="h-[100dvh] w-full max-w-[100vw] bg-gray-50 flex font-sans text-gray-800 selection:bg-blue-100 overflow-hidden">
      ...
      {/* --- MAIN CONTENT --- */}
      <main className="flex-1 lg:ml-72 flex flex-col h-full relative w-full max-w-full bg-slate-50/50">
           ...
           <div className="flex items-center gap-3 md:gap-4 shrink-0">
              ...
              <button 
                ...
                className={`relative p-2.5 rounded-full border transition-all ${
                  showNotifications ? 'bg-blue-50 text-blue-600 border-blue-200' : 'bg-white text-gray-500 border-gray-200 hover:bg-gray-50'
                }`}
              >
