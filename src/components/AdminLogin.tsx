...
export function AdminLogin({ onLogin, onBack }: AdminLoginProps) {
  ...
  useEffect(() => {
    const newLogs = [
      ...
      "Hazard Detection Model v2.4 Loaded",
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-[#0F172A] relative flex-col justify-between p-12 overflow-hidden border-r border-slate-800">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white tracking-tight">CrisisReady Command</h1>
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="flex border-b border-slate-200 mb-8">
            <button
              ...
              className={`pb-3 px-4 text-sm font-semibold transition-all relative ${loginMethod === 'email'
                ? 'text-emerald-700'
            ...
            <button
              ...
              className={`pb-3 px-4 text-sm font-semibold transition-all relative ${loginMethod === 'phone'
                ? 'text-emerald-700'
                : 'text-slate-400 hover:text-slate-600'
                }`}
            >
