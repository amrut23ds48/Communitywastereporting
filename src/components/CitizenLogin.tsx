...
export function CitizenLogin({ onLogin, onBack }: CitizenLoginProps) {
  ...
  const [activities, setActivities] = useState<string[]>([
    "🌱 Sarah planted a tree in Sector 4",
    "🗑️ Rahul reported overflow at Main St",
    "✅ Waste cleared at Gandhi Road",
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-[#022c22] relative flex-col justify-between p-12 overflow-hidden text-white">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-white">SwachhFlow</h1>
        ...
        <div className="relative z-10 max-w-md w-full mx-auto animate-in fade-in zoom-in duration-500">
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-gray-500 text-base leading-relaxed">
              {isSignUp 
                ? "Join your neighbors in making our city cleaner and smarter. It takes less than a minute." 
          ...
          <div className="mt-8 pt-8 border-t border-gray-100 text-center">
            ...
            >
              ...
              <span>Developer Demo: Auto-fill Citizen</span>
            </button>
          </div>
